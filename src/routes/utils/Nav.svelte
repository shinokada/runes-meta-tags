...
<Navbar fluid class="sticky top-0 z-40 mx-auto w-full flex-none border-b border-gray-200 dark:border-gray-600 dark:bg-stone-900" navContainerClass="md:justify-between">
  <NavBrand href="/">
